...
<div class="row">
    ...
    foreach($utilisateurs as $key => $value) :
        ?>
        <form action="traitement-modif-profil.php?modification=<?= $_GET["modification"]; ?>" enctype="multipart/form-data" method="post" class="col s12 m12 offset-l3 l6">
